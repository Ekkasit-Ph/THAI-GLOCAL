...
public class WorkshopService {
    ...
    public Flux<WorkshopResponse> getAll(String cookieHeader) {
        return workshopWebClient
                ...
                .onStatus(HttpStatusCode::is4xxClientError,
                        cr -> Mono.error(new RuntimeException("Client error during getAll workshops")))
                .onStatus(HttpStatusCode::is5xxServerError,
                        cr -> Mono.error(new RuntimeException("Server error during getAll workshops")))
    ...
    public Flux<WorkshopResponse> searchByName(String name, String cookieHeader) {
        return workshopWebClient
                .get()
                .uri(uriBuilder -> uriBuilder.path("/api/workshops/search").queryParam("name", name).build())
                .headers(h -> addCookie(h, cookieHeader))
                .retrieve()
                .onStatus(HttpStatusCode::is4xxClientError,
                        cr -> Mono.error(new RuntimeException("Client error during searchByName")))
                .onStatus(HttpStatusCode::is5xxServerError,
                        cr -> Mono.error(new RuntimeException("Server error during searchByName")))
                .bodyToFlux(WorkshopResponse.class);
    }
    ...
    public Flux<WorkshopResponse> getByCenter(Long centerId, String cookieHeader) {
        return workshopWebClient
                ...
                .retrieve()
                .onStatus(HttpStatusCode::is4xxClientError,
                        cr -> Mono.error(new RuntimeException("Client error during getByCenter")))
                .onStatus(HttpStatusCode::is5xxServerError,
                        cr -> Mono.error(new RuntimeException("Server error during getByCenter")))
                .bodyToFlux(WorkshopResponse.class);
    }
    ...
    public Flux<WorkshopResponse> getByCenterAndType(Long centerId, String workshopType, String cookieHeader) {
        return workshopWebClient
                ...
                .retrieve()
                .onStatus(HttpStatusCode::is4xxClientError,
                        cr -> Mono.error(new RuntimeException("Client error during getByCenterAndType")))
                .onStatus(HttpStatusCode::is5xxServerError,
                        cr -> Mono.error(new RuntimeException("Server error during getByCenterAndType")))
                .bodyToFlux(WorkshopResponse.class);
    }
    ...
    public Mono<Void> create(WorkshopRequest request, String cookieHeader) {
        return workshopWebClient
                ...
                .retrieve()
                .onStatus(HttpStatusCode::is4xxClientError,
                        cr -> Mono.error(new RuntimeException("Client error during create workshop")))
                .onStatus(HttpStatusCode::is5xxServerError,
                        cr -> Mono.error(new RuntimeException("Server error during create workshop")))
    ...
    public Mono<Void> update(Long workshopId, WorkshopRequest request, String cookieHeader) {
        return workshopWebClient
                ...
                .retrieve()
                .onStatus(HttpStatusCode::is4xxClientError,
                        cr -> Mono.error(new RuntimeException("Client error during update workshop")))
                .onStatus(HttpStatusCode::is5xxServerError,
                        cr -> Mono.error(new RuntimeException("Server error during update workshop")))
                .bodyToMono(Void.class);
    }
    ...
    public Mono<Void> delete(Long workshopId, String cookieHeader) {
        return workshopWebClient
                ...
                .retrieve()
                .onStatus(HttpStatusCode::is4xxClientError,
                        cr -> Mono.error(new RuntimeException("Client error during delete workshop")))
                .onStatus(HttpStatusCode::is5xxServerError,
                        cr -> Mono.error(new RuntimeException("Server error during delete workshop")))
                .bodyToMono(Void.class);
    }
